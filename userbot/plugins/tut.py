...
After that go to github.com and search JaaduBot or just clink HERE Then Open that in Desktop site.

Click on the Fork option in the top right corner

Then you will see a deploy to heroku button just click on that and fill the info. Done your bot is done😍☺️
Join @jaadubotofficial for any help.
